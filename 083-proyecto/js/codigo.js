...
fetch("json/articulos.json").then(function(e){
    ...
    if(partido[1] == null){
        ...
        if(data.articulos[partido[1]].codigovideo != null){
            codigovideo = data.articulos[partido[1]].codigovideo
        }else{
            codigovideo = "_LbSL3G6S6Q"
        }
